...
const showMenu = (toggleId, navId) =>{
    ...
    // Validar a existência de variáveis
    if(toggle && nav){
...
function scrollHeader(){
    ...
    // Quando a rolagem for maior que 200 de altura da janela de visualização, adiciona a classe scroll-header à tag de cabeçalho
...
function scrollTop(){
    ...
    // Quando a rolagem for maior que 560 da altura da janela de visualização, adiciona a classe show-scroll à tag a com a classe scroll-top
...
// Tópico selecionado anteriormente (se o usuário selecionar)
